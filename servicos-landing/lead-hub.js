 ...
 *
 * Configuração global: /Users/mac/repo-portfolio/.lead-hub/config.json
 */
...
(function () {
  ...
  function buildConfigUrl() {
    ...
    return origin + DEFAULT_CONFIG_URL;
  }
  ...
  function loadConfig() {
    return new Promise(function (resolve, reject) {
      ...
      fetch(configUrl, { method: 'GET', mode: 'cors' })
        ...
        .catch(function (err) {
          console.warn('[LeadHub] Não foi possível carregar config.json. Usando fallback local.', err);
          resolve({
